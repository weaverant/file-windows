...
Windows build of the Unix [file](https://github.com/file/file) utility (version 5.46).

Forked from [julian-r/file-windows](https://github.com/julian-r/file-windows). 5.46 update based on [ember91/file-windows](https://github.com/ember91/file-windows).

## What's different from julian-r's fork

- Updated to file 5.46 (was 5.44)
